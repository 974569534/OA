...
public class EamilController {
	...
	public String insert(Eamil eamil) throws Exception{
        ...
        */
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session, mail.getMyEmailAccount(), mail.getReceiveMailAccount(),eamil);
     ...
     * @throws Exception
     */
    public MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, Eamil eamil) throws Exception {
        // 1. 创建一封邮件
